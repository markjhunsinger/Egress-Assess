...
| `--json-out` | — | Write sweep results to a JSON file (e.g. `results.json`) |
...
| DNS (TXT) | Client sends SHA256 in final query; server returns its SHA256 in DNS reply |
| dns_resolved / ICMP | No verification (fire-and-forget) |
